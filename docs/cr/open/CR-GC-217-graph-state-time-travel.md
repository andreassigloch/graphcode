...
> Renumbered from CR-GC-217 → CR-GC-217 on 2026-06-27: a concurrent session had
> already taken CR-GC-217 for `graph_realize affordance`. Same content, new number.

**Status:** OPEN — Approach A foundation IMPLEMENTED (slice 1); ergonomics deferred (slice 2)
**Date:** 2026-06-27
