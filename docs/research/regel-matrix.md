...
> 76 Regeln · 62 im Gate-Katalog · 5 blocken (Stufe error) · 3 Prompt/Skill-Konflikte (Ausnahmen in tests/skill-rule-ids.test.ts).
...
| Regel | Name | Bedarf | Stufe | Task | Phase | Dimension | Steuerregel | abnehmbar in | Hilfe-Prompt | Skill | Konflikt | nennt |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| CR-R01 | CR must track | Gate | warning | plan | SRR | cr |  | plan |  | se-plan |  |  |
...
| MS-03 | CR without milestone | Gate | info | plan | SRR | ms |  |  | se-plan | se-plan |  |  |
| MT-01 | Module instability | Gate | warning | kern | PDR | alloc |  |  |  | se:top-level |  |  |
| MT-02 | Module cohesion (LCOM4) | Gate | info | kern | PDR | alloc | ja |  |  | se:top-level |  | se:top-level |
...
| R-02 | FUNC must satisfy REQ | Gate | warning | kern | PDR | arch |  |  |  | se:top-level |  | se-fmea |
...
| R-18 | Valid trace pattern | Gate | error | kern | PDR | arch |  |  |  | se:top-level |  | se:author-actor se:import-doc se-fmea se-plan |
...
| R-22 | FUNC must be allocated to MOD | Gate | warning | kern | PDR | alloc |  |  |  | se:top-level |  | se:top-level |
| R-23 | MOD must have allocated FUNC | Gate | warning | kern | PDR | alloc |  |  |  | se:top-level |  |  |
...
| R-30 | FUNC leaf must belong to a function chain | Gate | warning | kern | PDR | arch |  |  |  | se:top-level |  | se:top-level |
| R-31 | FUNC must be wired (io input + output) | Gate | warning | kern | PDR | arch |  |  |  | se:top-level |  |  |
...
| RD-01 | Unresolved requirement | Gate | warning | kern | SRR | req |  |  | se:close-violations | se:author-req | ja | se:author-req |
| RD-02 | Decomposition consistency | Gate | warning | kern | SRR | req |  |  |  | se:author-req |  |  |
| RD-03 | No premature decomposition | Gate | info | kern | SRR | req |  |  |  | se:author-req |  |  |
...
| SC-02 | Schema referenced by FLOW | Gate | warning | kern | CDR | schema |  |  |  |  |  |  |
...
| UC-02 | UC has actor | Gate | warning | kern | SRR | uc |  |  | se:author-uc | se:author-uc |  | se:author-actor se:author-uc |
...
| UC-05 | UC has postcondition | Gate | info | kern | SRR | uc |  |  |  | se:author-uc |  |  |
| UC-06 | UC has precondition | Gate | info | kern | SRR | uc |  |  |  | se:author-uc |  |  |
