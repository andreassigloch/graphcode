...
> GENERATED from `docs/graph/graphcode.graph.json` (SSOT). 106 REQ rows, sortiert nach uid. Deterministisch generiert.
...
| `REQ-artifact-freshness` | `TEST-artifact-freshness` | `FUNC-render-artifacts` | `MOD-dashboard` |
...
| `REQ-readiness-transparent` | `TEST-readiness-transparent` | `FUNC-render-readiness` | `MOD-dashboard` |
| `REQ-readonly-bridge` | `TEST-readonly-bridge` | `FUNC-serve-sse` | `MOD-host-bridge` |
| `REQ-real-health-check` | `TEST-real-health-check` | `FUNC-health-endpoint` | `MOD-host-bridge` |
...
| `REQ-test-runnable-binding` | `TEST-test-runnable-binding` | `FUNC-deduce-tests` | `MOD-mcp-tools` |
...
| `REQ-versioned-broadcast` | `TEST-live-view` | `FUNC-broadcast-diff` · `FUNC-emit-update-event` | `MOD-hooks` · `MOD-host-bridge` |
