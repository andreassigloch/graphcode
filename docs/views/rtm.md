...
> GENERATED from `docs/graph/graphcode.graph.json` (SSOT). 129 REQ rows, nach Ebene gruppiert, innerhalb sortiert nach uid. Deterministisch generiert.
