...
> GENERATED from `docs/graph/graphcode.graph.json` (SSOT). REQ × TEST Coverage, 106 REQ rows. Deterministisch generiert.
...
Coverage: 106/106 REQ verified (100%) · 0 open (R-01).
