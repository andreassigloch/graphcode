...
```
        ...
        ╱────────────╲      ✗ 222/654 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (654 conn) | integration (chain) | 95 | 222 / 654 connections | ✗ 432 uncovered |
...
> surfaces as ✗ (222/654 covered) instead of being silently absent.
