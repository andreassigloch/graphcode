...
```
        ...
        ╱────────────╲      ✗ 140/278 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (278 conn) | integration (chain) | 95 | 140 / 278 connections | ✗ 138 uncovered |
...
> surfaces as ✗ (140/278 covered) instead of being silently absent.
