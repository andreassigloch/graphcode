...
```
        ...
        ╱────────────╲      ✗ 140/259 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (259 conn) | integration (chain) | 95 | 140 / 259 connections | ✗ 119 uncovered |
...
> surfaces as ✗ (140/259 covered) instead of being silently absent.
