...
> GENERATED from `docs/graph/graphcode.graph.json` (SSOT). 134 TEST — Pyramide nach Modell-Level (System/UC/Function). Deterministisch generiert.
...
| Function | FUNC (128) | unit | 80 | 128 / 128 | ✓ |
