...
```
        ...
        ╱────────────╲      ✗ 227/672 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (672 conn) | integration (chain) | 95 | 227 / 672 connections | ✗ 445 uncovered |
...
> surfaces as ✗ (227/672 covered) instead of being silently absent.
