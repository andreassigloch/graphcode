...
```
        ...
        ╱────────────╲      ✗ 110/191 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (191 conn) | integration (chain) | 95 | 110 / 191 connections | ✗ 81 uncovered |
...
> surfaces as ✗ (110/191 covered) instead of being silently absent.
