...
```
        ...
        ╱────────────╲      ✗ 113/207 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (207 conn) | integration (chain) | 95 | 113 / 207 connections | ✗ 94 uncovered |
...
> surfaces as ✗ (113/207 covered) instead of being silently absent.
