...
```
        ...
        ╱────────────╲      ✗ 105/180 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (180 conn) | integration (chain) | 95 | 105 / 180 connections | ✗ 75 uncovered |
...
> surfaces as ✗ (105/180 covered) instead of being silently absent.
