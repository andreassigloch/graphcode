...
```
        ...
        ╱────────────╲      ✗ 199/515 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (515 conn) | integration (chain) | 95 | 199 / 515 connections | ✗ 316 uncovered |
...
> surfaces as ✗ (199/515 covered) instead of being silently absent.
