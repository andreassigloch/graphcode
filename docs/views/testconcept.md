...
```
        ...
        ╱────────────╲      ✗ 106/137 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (137 conn) | integration (chain) | 96 | 106 / 137 connections | ✗ 31 uncovered |
...
> surfaces as ✗ (106/137 covered) instead of being silently absent.
