...
```
        ...
        ╱────────────╲      ✗ 201/510 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (510 conn) | integration (chain) | 95 | 201 / 510 connections | ✗ 309 uncovered |
...
> surfaces as ✗ (201/510 covered) instead of being silently absent.
