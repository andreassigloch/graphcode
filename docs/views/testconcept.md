...
```
        ...
        ╱────────────╲      ✗ 97/166 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (166 conn) | integration (chain) | 94 | 97 / 166 connections | ✗ 69 uncovered |
...
> surfaces as ✗ (97/166 covered) instead of being silently absent.
