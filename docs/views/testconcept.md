...
```
        ...
        ╱────────────╲      ✓ 13/13 FUNC↔FUNC connections integration-tested
...
| Integration | FUNC↔FUNC (13 conn) | integration (chain) | 31 | 13 / 13 connections | ✓ |
...
> surfaces as ✗ (13/13 covered) instead of being silently absent.
