...
```
        ...
        ╱────────────╲      ✗ 110/190 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (190 conn) | integration (chain) | 95 | 110 / 190 connections | ✗ 80 uncovered |
...
> surfaces as ✗ (110/190 covered) instead of being silently absent.
