...
```
        ...
        ╱────────────╲      ✗ 117/150 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (150 conn) | integration (chain) | 101 | 117 / 150 connections | ✗ 33 uncovered |
...
> surfaces as ✗ (117/150 covered) instead of being silently absent.
