...
```
        ...
        ╱────────────╲      ✗ 110/200 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (200 conn) | integration (chain) | 95 | 110 / 200 connections | ✗ 90 uncovered |
...
> surfaces as ✗ (110/200 covered) instead of being silently absent.
