...
```
        ...
        ╱────────────╲      ✗ 99/170 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (170 conn) | integration (chain) | 94 | 99 / 170 connections | ✗ 71 uncovered |
...
> surfaces as ✗ (99/170 covered) instead of being silently absent.
