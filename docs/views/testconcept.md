...
```
        ...
        ╱────────────╲      ✗ 188/510 FUNC↔FUNC connections tested  ← GAP
...
| Integration | FUNC↔FUNC (510 conn) | integration (chain) | 95 | 188 / 510 connections | ✗ 322 uncovered |
...
> surfaces as ✗ (188/510 covered) instead of being silently absent.
