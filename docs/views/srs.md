...
Verification ◀ `TEST-host-shim` (integration) · `TEST-session-lifecycle` (integration) · `TEST-store-lock` (integration) · satisfy ◀ `FUNC-claim-store-lock` · `FUNC-close-store` · `FUNC-create-harness` · `FUNC-host-socket` · `FUNC-open-store` · `FUNC-own-kuzu-host` · allocate ▶ `MOD-kernel` · `MOD-surface`
...
##### 3.1.1.4  `FUNC-open-store` — initialize()

> auch in: `FUNC-block-speicherwerk`

Beansprucht die alleinige Store-Ownership, erkennt Meta-Modell-Drift und oeffnet den Kuzu-Store.

io ◀ `FLOW-graph-state` · `FLOW-schema-fingerprint` · `FLOW-store-ownership` · io ▶ `FLOW-graph-state` · allocate ▶ `MOD-kernel`
...
Verification ◀ `TEST-steering-loop` (integration) · satisfy ◀ `FUNC-open-store` · allocate ▶ `MOD-kernel`
...
##### 3.1.1.5  `FUNC-close-store` — close()

> auch in: `FUNC-block-speicherwerk`

Faehrt den Store herunter und gibt die Ownership wieder frei.

io ◀ `FLOW-graph-state` · io ▶ `FLOW-graph-state` · allocate ▶ `MOD-kernel`
...
##### 3.1.1.6  `FUNC-emit-trajectory` — materializeTrajectory()
...
##### 3.1.1.7  `FUNC-evaluate-rules` — evaluateRules()
...
io ◀ `FLOW-graph-state` · `FLOW-metric-policy` · `FLOW-module-metrics` · `FLOW-round-scope` · io ▶ `FLOW-gate-verdict` · allocate ▶ `MOD-kernel`
...
##### 3.1.1.8  `FUNC-save-graph` — saveGraph(graph)
...
io ◀ `FLOW-gate-verdict` · io ▶ `FLOW-graph-state` · allocate ▶ `MOD-kernel`
...
Verification ◀ `TEST-merge` (integration) · `TEST-occ` (integration) · satisfy ◀ `FUNC-auto-export` · `FUNC-load-graph` · `FUNC-merge-nodes` · `FUNC-save-graph` · allocate ▶ `MOD-kernel` · `MOD-projections`

##### 3.1.1.9  `FUNC-fit-advisory` — computeFitAdvisory(before, after)
...
io ◀ `FLOW-graph-state` · io ▶ `FLOW-fit-advisory` · allocate ▶ `MOD-kernel-measure`
...
##### 3.1.1.10  `FUNC-mutate` — mutate(commands)

> auch in: `FCHAIN-advisory-roundtrip` · `FCHAIN-capture` · `FCHAIN-interface-escalation` · `FCHAIN-live-update` · `FCHAIN-loop-closure` · `FCHAIN-modelfree-gate` · `FCHAIN-skill-authoring` · `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop` · `FUNC-block-gate`

Apply-Gate-Einstieg: wendet Commands in-memory an, orchestriert den 6-Schritt-Ablauf. (SPEC §3)

io ◀ `FLOW-fit-advisory` · `FLOW-formatE-artifact` · `FLOW-graph-state` · `FLOW-mutate-cmd` · io ▶ `FLOW-audit-record` · `FLOW-gate-verdict` · `FLOW-graph-state` · allocate ▶ `MOD-kernel`
...
##### 3.1.1.11  `FUNC-load-graph` — loadGraph()

> auch in: `FUNC-block-speicherwerk`

Laedt den persistierten Graphen in die Arbeitskopie des Gates.
...
##### 3.1.1.12  `FUNC-own-kuzu-host` — ownKuzu()
...
##### 3.1.1.13  `FUNC-session-shutdown` — SessionLifecycle
...
> auch in: `FCHAIN-advisory-roundtrip` · `FCHAIN-apply-gate` · `FCHAIN-interface-escalation` · `FCHAIN-live-update` · `FCHAIN-loop-closure` · `FCHAIN-modelfree-gate` · `FCHAIN-skill-authoring` · `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop` · `FUNC-block-gate`
...
> auch in: `FCHAIN-advisory-roundtrip` · `FCHAIN-apply-gate` · `FCHAIN-capture` · `FCHAIN-live-update` · `FCHAIN-loop-closure` · `FCHAIN-modelfree-gate` · `FCHAIN-skill-authoring` · `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop` · `FUNC-block-gate`
...
> auch in: `FCHAIN-advisory-roundtrip` · `FCHAIN-apply-gate` · `FCHAIN-capture` · `FCHAIN-interface-escalation` · `FCHAIN-live-update` · `FCHAIN-loop-closure` · `FCHAIN-modelfree-gate` · `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop` · `FUNC-block-gate`
...
io ◀ `FLOW-graph-state` · io ▶ `FLOW-gate-verdict` · allocate ▶ `MOD-kernel`
...
io ◀ `FLOW-completeness` · `FLOW-gate-verdict` · io ▶ `FLOW-phase-readiness` · allocate ▶ `MOD-kernel-measure`
...
io ◀ `FLOW-steering-snapshot` · io ▶ `FLOW-dimension-readiness` · allocate ▶ `MOD-projections`
...
Verification ◀ `TEST-readiness-model` (acceptance) · `TEST-views-auditor` (unit) · satisfy ◀ `FUNC-compute-readiness` · allocate ▶ `MOD-projections`
...
##### 3.2.2.2  `FUNC-take-steering-snapshot` — takeSteeringSnapshot(graph, policy)
...
io ◀ `FLOW-gate-verdict` · `FLOW-metric-policy` · `FLOW-steering-trigger` · io ▶ `FLOW-gate-verdict` · `FLOW-measurement-vector` · `FLOW-steering-snapshot` · allocate ▶ `MOD-kernel-measure`
...
io ◀ `FLOW-dimension-readiness` · `FLOW-phase-readiness` · `FLOW-target-profile` · io ▶ `FLOW-round-prompt` · allocate ▶ `MOD-loop`
...
##### 3.2.2.7  `FUNC-extract-mutate` — extractMutateFromText
...
> auch in: `FCHAIN-advisory-roundtrip` · `FCHAIN-apply-gate` · `FCHAIN-capture` · `FCHAIN-interface-escalation` · `FCHAIN-live-update` · `FCHAIN-loop-closure` · `FCHAIN-modelfree-gate` · `FCHAIN-skill-authoring` · `FCHAIN-snapshot-freshness` · `FUNC-block-gate`
...
##### 3.2.2.9  `FUNC-arch-fitness` — metrics(graph, layer arch)
...
io ◀ `FLOW-arch-fitness` · `FLOW-fit-advisory` · `FLOW-round-prompt` · `FLOW-steering-delta` · io ▶ `FLOW-mutate-cmd` · allocate ▶ `MOD-loop`
...
io ◀ `FLOW-dimension-readiness` · `FLOW-learning-advice` · `FLOW-steering-snapshot` · io ▶ `FLOW-next-step-advice` · allocate ▶ `MOD-loop`
...
##### 3.4.3.3  `FUNC-save-graph` — saveGraph(graph)
...
##### 3.4.3.4  `FUNC-export-marker` — setExportPending
...
##### 3.4.3.5  `FUNC-graph-export-snapshot` — graph_export(views?)
...
##### 3.4.3.6  `FUNC-mutate` — mutate(commands)

> auch in: `FCHAIN-advisory-roundtrip` · `FCHAIN-apply-gate` · `FCHAIN-capture` · `FCHAIN-interface-escalation` · `FCHAIN-live-update` · `FCHAIN-loop-closure` · `FCHAIN-modelfree-gate` · `FCHAIN-skill-authoring` · `FCHAIN-steering-loop` · `FUNC-block-gate`
...
io ◀ `FLOW-live-event` · io ▶ `FLOW-live-event` · allocate ▶ `MOD-surface`
...
##### 3.5.1.3  `FUNC-serve-stdio` — serveStdio()
...
io ◀ `FLOW-gate-verdict` · io ▶ `FLOW-health-report` · allocate ▶ `MOD-surface`
...
##### 3.5.1.7  `FUNC-save-graph` — saveGraph(graph)
...
> auch in: `FCHAIN-advisory-roundtrip` · `FCHAIN-apply-gate` · `FCHAIN-capture` · `FCHAIN-interface-escalation` · `FCHAIN-loop-closure` · `FCHAIN-modelfree-gate` · `FCHAIN-skill-authoring` · `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop` · `FUNC-block-gate`
...
> auch in: `FCHAIN-advisory-roundtrip` · `FCHAIN-apply-gate` · `FCHAIN-capture` · `FCHAIN-interface-escalation` · `FCHAIN-live-update` · `FCHAIN-modelfree-gate` · `FCHAIN-skill-authoring` · `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop` · `FUNC-block-gate`
...
##### 3.7.2.2  `FUNC-import` — importGraph(formatE, mode)

> auch in: `FUNC-block-gedaechtnis`

Format-E-Bulk-Import (replace/merge) ausschließlich durchs Gate; Cold-Start aus graphify/Slicer-Output.

io ◀ `FLOW-formatE-artifact` · io ▶ `FLOW-gate-verdict` · allocate ▶ `MOD-kernel`
...
io ◀ `FLOW-cli-command` · `FLOW-harness-handle` · io ▶ `FLOW-gate-verdict` · allocate ▶ `MOD-surface`
...
> auch in: `FCHAIN-apply-gate` · `FCHAIN-capture` · `FCHAIN-interface-escalation` · `FCHAIN-live-update` · `FCHAIN-loop-closure` · `FCHAIN-modelfree-gate` · `FCHAIN-skill-authoring` · `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop` · `FUNC-block-gate`
...
> auch in: `FCHAIN-advisory-roundtrip` · `FCHAIN-apply-gate` · `FCHAIN-capture` · `FCHAIN-interface-escalation` · `FCHAIN-live-update` · `FCHAIN-loop-closure` · `FCHAIN-skill-authoring` · `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop` · `FUNC-block-gate`
...
##### 3.8.3.2  `FUNC-evaluate-rules` — evaluateRules()
...
io ◀ `FLOW-harness-handle` · `FLOW-tool-context` · io ▶ `FLOW-tool-registry` · allocate ▶ `MOD-surface`
...
io ◀ `FLOW-cli-command` · `FLOW-formatE-artifact` · io ▶ `FLOW-gate-verdict` · allocate ▶ `MOD-surface`
...
> auch in: `FCHAIN-advisory-roundtrip` · `FCHAIN-apply-gate` · `FCHAIN-capture` · `FCHAIN-interface-escalation` · `FCHAIN-live-update` · `FCHAIN-loop-closure` · `FCHAIN-modelfree-gate` · `FCHAIN-skill-authoring` · `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop`
...
###### 3.10.2.2.4  `FUNC-save-graph` — saveGraph(graph)
...
###### 3.10.2.6.5  `FUNC-close-store` — close()
...
###### 3.10.2.6.6  `FUNC-create-harness` — createHarness
...
###### 3.10.2.6.7  `FUNC-export-marker` — setExportPending
...
###### 3.10.2.6.8  `FUNC-load-graph` — loadGraph()
...
###### 3.10.2.6.9  `FUNC-open-store` — initialize()
...
###### 3.10.2.6.10  `FUNC-seed-from-json` — seedFromJson(relPath)
...
io ◀ `FUNC-compute-readiness` · io ▶ `FUNC-generation-step` · `FUNC-next-step` · `FUNC-se-retro` · `FUNC-se-review` · `FUNC-se-status` · `FUNC-test` · `FUNC-test-ui` · schema ▶ `SCHEMA-readiness-report`

### 4.11  `FLOW-element-slice` — Element-Scheibe
...
### 4.12  `FLOW-export-pending` — Export-Rueckstand
...
### 4.13  `FLOW-fit-advisory` — Fit-Advisory (Richtung im Metrikraum)
...
### 4.14  `FLOW-formatE-artifact` — Format-E-Artefakt (Snapshot, Diff, Impact-Slice)
...
### 4.15  `FLOW-gate-verdict` — Gate-Verdikt
...
### 4.16  `FLOW-graph-state` — Graph-State
...
### 4.17  `FLOW-harness-handle` — Harness-Griff
...
### 4.18  `FLOW-health-report` — Health-Report
...
### 4.19  `FLOW-impacted-tests` — Betroffene Tests
...
### 4.20  `FLOW-install-result` — Lifecycle-Result
...
### 4.21  `FLOW-learning-advice` — Lern-Empfehlung
...
### 4.22  `FLOW-learning-query` — Lern-Frage
...
### 4.24  `FLOW-markdown-docs` — Exportierte Sichten
...
### 4.26  `FLOW-metric-policy` — Urteils-Policy
...
### 4.27  `FLOW-model-answer` — Modellantwort
...
### 4.30  `FLOW-next-step-advice` — Naechster Schritt (Advisory)
...
### 4.32  `FLOW-query-request` — Query-Request (Lese- und View-Anfrage)
...
### 4.33  `FLOW-rendered-views` — Gerenderte Sicht (Skill)
...
### 4.34  `FLOW-round-injection` — Runden-Injektion
...
### 4.35  `FLOW-round-prompt` — Runden-Vorgabe
...
### 4.36  `FLOW-round-scope` — Round Scope (bounded slice)
...
### 4.37  `FLOW-schema-fingerprint` — Schema-Fingerabdruck
...
### 4.38  `FLOW-session-entry` — Sitzungseintrag
...
### 4.39  `FLOW-session-registry` — Sitzungsregister
...
### 4.40  `FLOW-skill-report` — Skill-Bericht
...
### 4.41  `FLOW-skill-request` — Skill-Aufruf
...
### 4.42  `FLOW-steering-delta` — Steering-Delta (vor/nach Kandidat)
...
### 4.43  `FLOW-steering-snapshot` — Steering-Snapshot
...
### 4.44  `FLOW-steering-trigger` — Runden-Ausloeser
...
### 4.45  `FLOW-store-ownership` — Store-Besitzanspruch

Der Anspruch auf den Kuzu-Store eines Repos: gehalten, uebernommen oder verweigert.

io ◀ `FUNC-claim-store-lock` · io ▶ `FUNC-create-harness` · `FUNC-open-store` · `FUNC-own-kuzu-host` · `FUNC-session-shutdown` · schema ▶ `SCHEMA-lock-owner`

### 4.46  `FLOW-target-profile` — Zielprofil
...
### 4.47  `FLOW-target-profile-file` — Zielprofil (Rohform)
...
### 4.48  `FLOW-test-selection` — Selektive Testauswahl
...
### 4.49  `FLOW-tool-context` — Werkzeug-Kontext
...
### 4.50  `FLOW-tool-registry` — Werkzeug-Register
...
### 5.10  `SCHEMA-harness-handle` — Harness-Griff
...
### 5.14  `SCHEMA-learning-query` — Lern-Frage
...
### 5.17  `SCHEMA-measurement-vector` — Messvektor (Vertrag der vier Entscheidungen)
...
### 5.18  `SCHEMA-metric-policy` — MetricPolicy
...
### 5.19  `SCHEMA-metric-vector` — MetricVector
...
### 5.20  `SCHEMA-model-answer` — ModelAnswer
...
### 5.21  `SCHEMA-module-metrics` — ModuleMetrics
...
### 5.22  `SCHEMA-mutate-command` — MutateCommand
...
### 5.23  `SCHEMA-mutate-result` — MutateResult
...
### 5.24  `SCHEMA-ontology-graph` — OntologyGraph

Elements (13 ElementTypes) + Traces (7 TraceTypes). @sigloch/contracts/se.

schema ◀ `FLOW-element-slice` · `FLOW-graph-state`

### 5.25  `SCHEMA-phase-readiness` — PhaseGateReadiness

Je Gate: abgedeckte und alle Regel-IDs plus die fehlenden.

schema ◀ `FLOW-phase-readiness`

### 5.26  `SCHEMA-query-params` — QueryParams
...
### 5.29  `SCHEMA-round-scope` — Round-Scope-Slice
...
### 5.30  `SCHEMA-schema-fingerprint` — SchemaFingerprint
...
### 5.31  `SCHEMA-session-registry` — SessionEntry
...
### 5.34  `SCHEMA-target-profile` — TargetProfile
...
### 5.37  `SCHEMA-tool-registry` — Werkzeug-Register
...
### 5.38  `SCHEMA-trajectory` — Trajectory/Outcome
...
### 5.39  `SCHEMA-update-event` — UpdateEvent
...
allocate ◀ `FUNC-apply-reseed` · `FUNC-block-gate` · `FUNC-block-ruestzeug` · `FUNC-block-speicherwerk` · `FUNC-check-code-conformance` · `FUNC-claim-store-lock` · `FUNC-close-store` · `FUNC-evaluate-rules` · `FUNC-export-marker` · `FUNC-graph-expand` · `FUNC-graph-impact` · `FUNC-import` · `FUNC-list-elements` · `FUNC-load-config` · `FUNC-load-graph` · `FUNC-merge-nodes` · `FUNC-migrate-schema` · `FUNC-mutate` · `FUNC-open-store` · `FUNC-own-kuzu-host` · `FUNC-reseed` · `FUNC-resolve-tests-from-code` · `FUNC-save-graph` · `FUNC-schema-guard` · `FUNC-seed-from-json` · satisfy ▶ `REQ-batch-seed-performance` · `REQ-disk-persistence` · `REQ-gate-only-writes` · `REQ-harness-schema-in-contracts` · `REQ-hook-extension-points` · `REQ-hook-order-deterministic` · `REQ-import-se-ontology` · `REQ-precommit-timeout` · `REQ-prompt-provenance` · `REQ-quality-metric` · `REQ-rule-calibration` · `REQ-single-kuzu-owner` · `REQ-single-store` · `REQ-store-recovery` · `REQ-structural-rule-shared`
...
allocate ◀ `FUNC-compute-phase-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-nd-similarity` · `FUNC-take-steering-snapshot`
