...
> GENERATED from `docs/graph/graphcode.graph.json` (SSOT). Textuelle Spezifikation (29148-Anlehnung): compose=Hierarchie, io=Reihenfolge, REQ unter ihrem satisfy-Element. 142 REQ. Deterministisch generiert.
...
##### 3.1.1.5  `FUNC-arch-fitness` — metrics(graph, layer arch)
...
> auch unter: `FCHAIN-steering-loop` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
Verification ◀ `TEST-artifact-coupling` (integration) · `TEST-first-step` (integration) · `TEST-fit-advisory` (integration) · `TEST-steering-loop` (integration) · satisfy ◀ `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot` · allocate ▶ `MOD-kernel-measure` · `MOD-loop` · `MOD-projections`
...
> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
io ◀ `FLOW-skill-request` · io ▶ `FLOW-mutate-cmd-author-req` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-skill-request` · io ▶ `FLOW-mutate-cmd-author-uc` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-skill-request` · io ▶ `FLOW-mutate-cmd-close-violations` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-skill-request` · io ▶ `FLOW-mutate-cmd-se-conops` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-skill-request` · io ▶ `FLOW-mutate-cmd-se-fmea` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-skill-request` · io ▶ `FLOW-mutate-cmd-se-irr` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-skill-request` · io ▶ `FLOW-mutate-cmd-se-optimize` · allocate ▶ `MOD-agent-surface`
...
Prompt-realisierter Skill se:top-level: die oberste Ebene schneiden, also SYS-Blackbox, Anwendungsfaelle und Architekturziele, dann FUNC, FCHAIN mit Vertraegen und MOD mit hoechstens fuenf Bloecken je Ebene. Jeder Batch geht zuerst mit dryRun durch graph_mutate. (CR-GC-509)

io ◀ `FLOW-skill-request` · io ▶ `FLOW-mutate-cmd-se-top-level` · allocate ▶ `MOD-agent-surface`
...
> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
##### 3.2.1.8  `FUNC-function-criticality` — functionCriticality(graph)
...
> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
##### 3.2.1.12  `FUNC-compute-phase-readiness` — computePhaseReadiness(violations)
...
> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
##### 3.2.1.13  `FUNC-se-help` — Skill se:help
...
> auch unter: `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
##### 3.2.2.2  `FUNC-fit-advisory` — computeFitAdvisory(before, after)
...
##### 3.2.2.4  `FUNC-gate-client` — bindGateClient(registry, stats, trace)
...
> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-take-steering-snapshot`
...
##### 3.2.2.6  `FUNC-run-executor` — runExecutor
...
io ◀ `FLOW-candidate-ranking` · `FLOW-gate-outcome` · `FLOW-model-answer` · `FLOW-recovered-batch` · `FLOW-round-injection` · `FLOW-round-prompt` · `FLOW-run-request` · io ▶ `FLOW-candidate-batch` · `FLOW-model-request` · allocate ▶ `MOD-loop`
...
##### 3.2.2.8  `FUNC-call-model` — buildCallModel(config)
...
##### 3.2.2.9  `FUNC-extract-mutate` — extractMutateFromText
...
##### 3.2.2.10  `FUNC-compute-phase-readiness` — computePhaseReadiness(violations)
...
##### 3.2.2.11  `FUNC-take-steering-snapshot` — takeSteeringSnapshot(graph, policy)
...
> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates`
...
##### 3.2.2.12  `FUNC-generation-step` — generationStep(graph, policy, intent)
...
io ◀ `FLOW-measurement-vector` · `FLOW-steering-snapshot` · `FLOW-target-profile` · io ▶ `FLOW-round-prompt` · allocate ▶ `MOD-loop`

###### `REQ-steering-from-metrics` — Naechster Schritt folgt aus gemessenen Kenngroessen

> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
##### 3.2.2.13  `FUNC-build-round-injection` — buildRoundInjection
...
io ◀ `FLOW-learning-advice` · `FLOW-measurement-vector` · `FLOW-steering-snapshot` · io ▶ `FLOW-next-step-advice` · allocate ▶ `MOD-loop`

###### `REQ-steering-from-metrics` — Naechster Schritt folgt aus gemessenen Kenngroessen

> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-goal-steerer` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
##### 3.2.2.16  `FUNC-compute-readiness` — computeReadiness(graph)
...
##### 3.2.2.17  `FUNC-graph-readiness` — graph_readiness(detail?)
...
##### 3.2.2.18  `FUNC-held-back-traces` — heldBackTraces(repoRoot, systemId, live)
...
##### 3.2.2.19  `FUNC-list-elements` — listElements(filter)
...
##### 3.2.2.20  `FUNC-load-config` — loadGraphcodeConfig
...
##### 3.2.2.21  `FUNC-nd-similarity` — duplicateHits
...
##### 3.2.2.22  `FUNC-run-verb` — executeRun
...
##### 3.2.2.23  `FUNC-target-profile` — Skill se:target-profile
...
##### 3.2.2.24  `FUNC-target-profile-load` — loadTargetProfile
...
io ◀ `FLOW-query-request-agent` · io ▶ `FLOW-impacted-tests` · allocate ▶ `MOD-kernel`
...
io ◀ `FLOW-cli-invocation` · `FLOW-impacted-tests` · io ▶ `FLOW-code-lane-plan` · allocate ▶ `MOD-projections`

###### `REQ-selective-code-lane` — Abgeleitete Code-Testspur mit ehrlicher Reichweite

Die lokale Testspur einer Code-Aenderung wird aus dem Modell abgeleitet statt als volle Suite gefahren. Sie faellt auf die volle Suite zurueck, sobald eine geaenderte Quelldatei keinen Knoten hat, ein Volllauf-Ausloeser im Diff liegt oder die Auswahl leer bliebe, und sie nennt in jeder Ausgabe die Bindungsquote des Changesets sowie jeden betroffenen TEST ohne Laufadresse.
...
io ◀ `FLOW-gate-verdict` · `FLOW-graph-state` · io ▶ `FLOW-mutate-cmd-test-ingest` · allocate ▶ `MOD-projections`
...
io ◀ `FLOW-graph-state` · io ▶ `FLOW-mutate-cmd-merge-nodes` · allocate ▶ `MOD-kernel`
...
Erstbefuellung des Stores aus dem committeten Snapshot ueber den Import-Port — eine Operation, kein Edit, deshalb ohne Gate. Prueft jede Kante mit derselben Routine wie R-18 und haelt Kanten ohne Muster zurueck, statt den Boot abbrechen zu lassen; das Ergebnis nennt sie (rejectedTraces), der Host warnt beim Boot. (CR-GC-467, CR-GC-530)

io ◀ `FLOW-graph-state` · io ▶ `FLOW-ontology-json` · allocate ▶ `MOD-kernel`

###### `REQ-bootstrap-through-gate` — Ungeprueften Bestand nur durchs Gate

> auch unter: `FUNC-bootstrap` · `FUNC-import`

Ein Bestand, der noch nie gegen die Grammatik geprueft wurde (Format-E aus graphify, Slicer oder Dokument), gelangt ausschliesslich ueber mutate() in den Store (bootstrap). Das Laden eines schon governten, committeten Snapshots (seedFromJson, importGraph, reseed, rewind) ist eine Operation, kein Edit: es ersetzt den Zustand ohne Gate, prueft aber jede Kante mit derselben Routine wie R-18, haelt musterfremde zurueck und meldet REQ ohne TEST — nie still. (CR-GC-122, CR-GC-467, CR-GC-530)
...
> auch unter: `FUNC-graph-export-snapshot` · `FUNC-graph-readiness` · `FUNC-held-back-traces`
...
##### 3.4.2.6  `FUNC-held-back-traces` — heldBackTraces(repoRoot, systemId, live)

> auch in: `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop` · `FUNC-block-speicherwerk`
...
##### 3.4.2.7  `FUNC-import` — importGraph(ontology, opts)

> auch in: `FUNC-block-gedaechtnis`

Laedt einen materialisierten OntologyGraph (elements/traces) per Import-Port in den Store (replace) — direkte Ladung eines governten Bestands, kein Gate. Meldet REQ ohne verifizierenden TEST (auf Wunsch Abbruch) und haelt Kanten ohne Muster zurueck (rejectedTraces). Ungeprueftes Format-E laeuft ueber bootstrap durchs Gate. (CR-GC-260, CR-GC-530)
...
###### `REQ-post-import` — Postcondition: importGraph(ontology, opts)
...
###### `REQ-pre-import` — Precondition: importGraph(ontology, opts)
...
> auch in: `FCHAIN-recall` · `FCHAIN-steering-loop` · `FUNC-block-speicherwerk`
...
##### 3.4.3.2  `FUNC-graph-export-snapshot` — graph_export(views?)
...
> auch unter: `FUNC-graph-readiness` · `FUNC-held-back-traces` · `FUNC-seed-from-json`
...
##### 3.4.3.3  `FUNC-auto-export` — registerAutoExport
...
io ◀ `FLOW-graph-state` · io ▶ `FLOW-query-request-auto-export` · allocate ▶ `MOD-projections`
...
##### 3.4.3.7  `FUNC-export-marker` — setExportPending
...
io ◀ `FLOW-query-request-agent` · `FLOW-query-request-auto-export` · `FLOW-query-request-owner` · `FLOW-query-request-render-views` · `FLOW-query-request-view-changelog` · `FLOW-query-request-view-conops` · `FLOW-query-request-view-icd` · `FLOW-query-request-view-intplan` · `FLOW-query-request-view-rtm` · io ▶ `FLOW-markdown-docs` · allocate ▶ `MOD-projections`
...
io ◀ `FLOW-query-request-owner` · io ▶ `FLOW-query-request-view-changelog` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-query-request-owner` · io ▶ `FLOW-query-request-view-conops` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-query-request-owner` · io ▶ `FLOW-query-request-view-icd` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-query-request-owner` · io ▶ `FLOW-query-request-view-intplan` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-query-request-owner` · io ▶ `FLOW-query-request-view-rtm` · allocate ▶ `MOD-agent-surface`
...
io ◀ `FLOW-query-request-agent` · `FLOW-query-request-owner` · io ▶ `FLOW-expand-subgraph` · allocate ▶ `MOD-kernel`
...
io ◀ `FLOW-cli-command` · `FLOW-gate-verdict` · io ▶ `FLOW-mutate-cmd-bootstrap` · allocate ▶ `MOD-surface`
...
io ◀ `FLOW-cli-command` · io ▶ `FLOW-install-result-collect-status` · allocate ▶ `MOD-surface`
...
io ◀ `FLOW-cli-command` · io ▶ `FLOW-install-result-upgrade` · allocate ▶ `MOD-surface`
...
##### 3.10.1.1  `FUNC-block-bedienung` — Bedienung

Ebene-1-Block im Betrieb: die Verben, mit denen ein Mensch das Repo einrichtet, aktualisiert und Laeufe faehrt — CLI-Dispatch, Lebenszyklus-Verben, Status, Upgrade, import-code und run. Ein Verb laeuft einmal und endet; der laufende Host der Sitzung steht daneben in Host & Sitzung. (CR-GC-459, Z3-Spike ITEM-2026-053)
...
###### 3.10.1.1.3  `FUNC-harness-cli` — graphcode init/update/remove
...
###### 3.10.1.1.4  `FUNC-import-code-verb` — executeImportCode
...
##### 3.10.1.2  `FUNC-block-host-sitzung` — Host & Sitzung

Ebene-1-Block im Betrieb: der laufende Host einer Sitzung — MCP-Transport, Host-Socket zum Store-Besitzer, Viewer-Aufsicht, Gesundheitsabfrage und der geordnete Abbau am Sessionende. Getrennt von den Verben, weil er lebt, solange die Sitzung lebt, waehrend ein Verb einmal laeuft und endet. (Z3-Spike ITEM-2026-053)

io ◀ — · io ▶ — · allocate ▶ `MOD-surface`

###### 3.10.1.2.1  `FUNC-gve-sessions` — liveSessions
...
###### 3.10.1.2.2  `FUNC-gve-supervise` — attachGve
...
###### 3.10.1.2.3  `FUNC-health-endpoint` — healthEndpoint()
...
###### 3.10.1.2.4  `FUNC-host-socket` — startHostSocket
...
###### 3.10.1.2.6  `FUNC-session-shutdown` — SessionLifecycle
...
###### 3.10.1.3.1  `FUNC-bind-tools` — bindToolsToHarness
...
###### 3.10.1.3.2  `FUNC-load-config` — loadGraphcodeConfig
...
###### 3.10.1.3.3  `FUNC-migrate-schema` — migrateSchema(from, to)
...
###### 3.10.1.3.4  `FUNC-schema-guard` — schemaFingerprint
...
###### 3.10.1.3.5  `FUNC-tool-context` — createToolContext
...
###### 3.10.2.1.6  `FUNC-graph-readiness` — graph_readiness(detail?)
...
###### 3.10.2.1.7  `FUNC-list-elements` — listElements(filter)
...
###### 3.10.2.1.8  `FUNC-read-tools` — bindReadTools(ctx)
...
###### 3.10.2.1.9  `FUNC-resolve-tests-from-code` — Gerichtete code→REQ→TEST-Auflösung
...
###### 3.10.2.1.10  `FUNC-test-ingest` — graph_test_ingest
...
###### 3.10.2.2.1  `FUNC-export-markdown` — exportMarkdown(graph, view)
...
###### 3.10.2.2.2  `FUNC-render-views` — render graph→markdown views
...
##### 3.10.2.4  `FUNC-block-gedaechtnis` — Gedächtnis
...
###### 3.10.2.5.1  `FUNC-broadcast-diff` — broadcastDiff(version)
...
###### 3.10.2.5.2  `FUNC-emit-update-event` — emitUpdateEvent(domains)
...
###### 3.10.2.5.3  `FUNC-serve-sse` — serveSSE()
...
##### 3.10.2.6  `FUNC-block-messwerk` — Messwerk
...
###### 3.10.2.6.1  `FUNC-arch-fitness` — metrics(graph, layer arch)
...
##### 3.10.2.7  `FUNC-block-speicherwerk` — Speicherwerk
...
###### 3.10.2.7.1  `FUNC-apply-reseed` — applyReseed
...
###### 3.10.2.7.3  `FUNC-bootstrap` — bootstrap
...
###### 3.10.2.7.4  `FUNC-claim-store-lock` — StoreLock
...
###### 3.10.2.7.6  `FUNC-export-marker` — setExportPending
...
###### 3.10.2.7.8  `FUNC-held-back-traces` — heldBackTraces(repoRoot, systemId, live)

> auch in: `FCHAIN-recall` · `FCHAIN-snapshot-freshness` · `FCHAIN-steering-loop`
...
###### 3.10.2.7.9  `FUNC-seed-from-json` — seedFromJson(relPath)
...
##### 3.10.3.1  `FUNC-block-urteilsarbeit` — Urteilsarbeit
...
###### 3.10.3.1.1  `FUNC-se-conops` — Skill se-conops
...
io ◀ — · io ▶ `FLOW-action` · allocate ▶ `MOD-loop`

##### `REQ-steering-from-metrics` — Naechster Schritt folgt aus gemessenen Kenngroessen

> auch unter: `FCHAIN-steering-loop` · `FUNC-arch-fitness` · `FUNC-compute-phase-readiness` · `FUNC-compute-readiness` · `FUNC-compute-steering-delta` · `FUNC-fit-advisory` · `FUNC-function-criticality` · `FUNC-generation-step` · `FUNC-module-metrics` · `FUNC-next-step` · `FUNC-rank-candidates` · `FUNC-take-steering-snapshot`
...
### 4.8  `FLOW-cli-command` — CLI-Kommando
...
### 4.9  `FLOW-cli-invocation` — CLI-Aufruf (Rohform)
...
### 4.10  `FLOW-code-lane-plan` — Plan der Code-Spur
...
### 4.11  `FLOW-completeness` — Completeness je Gate
...
### 4.12  `FLOW-config-file` — Repo-Konfiguration (Rohform)
...
### 4.13  `FLOW-conformance-findings` — Konformanzbefunde
...
### 4.14  `FLOW-dimension-readiness` — Dimensions-Readiness (8 Scores)
...
### 4.15  `FLOW-element-slice` — Element-Scheibe
...
### 4.16  `FLOW-expand-subgraph` — Vertiefter Teilgraph
...
### 4.17  `FLOW-export-pending` — Export-Rueckstand
...
### 4.18  `FLOW-fit-advisory` — Fit-Advisory (Richtung im Metrikraum)
...
### 4.19  `FLOW-formatE-artifact-agent` — Format-E-Artefakt (Agent)
...
### 4.20  `FLOW-formatE-artifact-read-tools` — Format-E-Artefakt (read-tools)
...
### 4.21  `FLOW-function-criticality` — Kritikalitaet je FUNC
...
### 4.22  `FLOW-gate-outcome` — Gate-Ausgang des Executors
...
### 4.23  `FLOW-gate-verdict` — Gate-Verdikt
...
### 4.24  `FLOW-graph-delta` — Angenommenes Delta
...
### 4.25  `FLOW-graph-state` — Graph-State
...
### 4.26  `FLOW-harness-handle` — Harness-Griff
...
### 4.27  `FLOW-health-report` — Health-Report
...
### 4.28  `FLOW-held-back-traces` — Zurueckgehaltene Kanten
...
### 4.29  `FLOW-impact-slice` — Impact-Scheibe
...
### 4.30  `FLOW-impacted-tests` — Betroffene Tests
...
### 4.31  `FLOW-imported-graph` — Importierter Graph
...
### 4.32  `FLOW-install-result-collect-status` — Lifecycle-Result (collect-status)
...
### 4.33  `FLOW-install-result-harness-cli` — Lifecycle-Result (harness-cli)
...
### 4.34  `FLOW-install-result-upgrade` — Lifecycle-Result (upgrade)
...
### 4.35  `FLOW-learning-advice` — Lern-Empfehlung
...
### 4.36  `FLOW-learning-query` — Lern-Frage
...
### 4.37  `FLOW-live-event` — Live-Update-Event
...
### 4.38  `FLOW-markdown-docs` — Exportierte Sichten
...
io ◀ `FUNC-take-steering-snapshot` · io ▶ `FUNC-generation-step` · `FUNC-next-step` · schema ▶ `SCHEMA-measurement-vector`

### 4.42  `FLOW-metric-policy` — Urteils-Policy
...
### 4.43  `FLOW-model-answer` — Modellantwort
...
io ◀ `FUNC-call-model` · io ▶ `FUNC-extract-mutate` · `FUNC-run-executor` · schema ▶ `SCHEMA-model-answer`

### 4.44  `FLOW-model-request` — Modell-Anfrage
...
### 4.45  `FLOW-module-metrics` — Modulkennzahlen je MOD
...
### 4.46  `FLOW-mutate-cmd-agent` — Mutate-Command (Agent)
...
### 4.47  `FLOW-mutate-cmd-author-req` — Mutate-Command (author-req)
...
### 4.48  `FLOW-mutate-cmd-author-uc` — Mutate-Command (author-uc)
...
### 4.49  `FLOW-mutate-cmd-bootstrap` — Mutate-Command (bootstrap)
...
### 4.50  `FLOW-mutate-cmd-close-violations` — Mutate-Command (close-violations)
...
### 4.51  `FLOW-mutate-cmd-gate-client` — Mutate-Command (gate-client)
...
### 4.52  `FLOW-mutate-cmd-graph-realize` — Mutate-Command (graph-realize)
...
### 4.53  `FLOW-mutate-cmd-graph-suggest` — Mutate-Command (graph-suggest)
...
### 4.54  `FLOW-mutate-cmd-import-code-verb` — Mutate-Command (import-code-verb)
...
### 4.55  `FLOW-mutate-cmd-import-doc` — Mutate-Command (import-doc)
...
### 4.56  `FLOW-mutate-cmd-merge-nodes` — Mutate-Command (merge-nodes)
...
### 4.57  `FLOW-mutate-cmd-owner` — Mutate-Command (Owner)
...
### 4.58  `FLOW-mutate-cmd-se-conops` — Mutate-Command (se-conops)
...
### 4.59  `FLOW-mutate-cmd-se-fmea` — Mutate-Command (se-fmea)
...
### 4.60  `FLOW-mutate-cmd-se-generate` — Mutate-Command (se-generate)
...
### 4.61  `FLOW-mutate-cmd-se-irr` — Mutate-Command (se-irr)
...
### 4.62  `FLOW-mutate-cmd-se-optimize` — Mutate-Command (se-optimize)
...
### 4.63  `FLOW-mutate-cmd-se-plan` — Mutate-Command (se-plan)
...
### 4.64  `FLOW-mutate-cmd-se-top-level` — Mutate-Command (se-top-level)
...
### 4.65  `FLOW-mutate-cmd-se-trade` — Mutate-Command (se-trade)
...
### 4.66  `FLOW-mutate-cmd-test-ingest` — Mutate-Command (test-ingest)
...
### 4.67  `FLOW-next-step-advice` — Naechster Schritt (Advisory)
...
### 4.68  `FLOW-ontology-json` — Graph-Datei (Snapshot)
...
### 4.69  `FLOW-phase-readiness` — Phasen-Readiness (SRR/PDR/CDR/TRR)
...
### 4.70  `FLOW-preflight-outcome` — Preflight-Ergebnis
...
### 4.71  `FLOW-query-request-agent` — Query-Request (Agent)
...
io ◀ `ACTOR-agent` · io ▶ `FUNC-deduce-tests` · `FUNC-export-markdown` · `FUNC-graph-expand` · `FUNC-graph-impact` · `FUNC-graph-readiness` · `FUNC-list-elements` · `FUNC-read-tools` · `FUNC-resolve-tests-from-code` · schema ▶ `SCHEMA-query-params`

### 4.72  `FLOW-query-request-auto-export` — Query-Request (auto-export)
...
### 4.73  `FLOW-query-request-owner` — Query-Request (Owner)
...
### 4.74  `FLOW-query-request-render-views` — Query-Request (render-views)
...
### 4.75  `FLOW-query-request-view-changelog` — Query-Request (view-changelog)
...
### 4.76  `FLOW-query-request-view-conops` — Query-Request (view-conops)
...
### 4.77  `FLOW-query-request-view-fmea` — Query-Request (view-fmea)
...
### 4.78  `FLOW-query-request-view-icd` — Query-Request (view-icd)
...
### 4.79  `FLOW-query-request-view-intplan` — Query-Request (view-intplan)
...
### 4.80  `FLOW-query-request-view-rtm` — Query-Request (view-rtm)
...
### 4.81  `FLOW-readiness-report` — Readiness-Report (Agent)
...
### 4.82  `FLOW-recovered-batch` — Aus Prosa geborgener Batch
...
### 4.83  `FLOW-rendered-views` — Gerenderte Sicht (Skill)
...
### 4.84  `FLOW-round-injection` — Runden-Injektion
...
### 4.85  `FLOW-round-prompt` — Runden-Vorgabe
...
### 4.86  `FLOW-rule-findings` — Regelbefunde
...
### 4.87  `FLOW-run-request` — Lauf-Auftrag
...
io ◀ `FUNC-run-verb` · io ▶ `FUNC-run-executor` · schema ▶ `SCHEMA-query-params`

### 4.88  `FLOW-schema-fingerprint` — Schema-Fingerabdruck
...
### 4.89  `FLOW-session-entry` — Sitzungseintrag
...
### 4.90  `FLOW-session-registry` — Sitzungsregister
...
### 4.91  `FLOW-skill-report-se-help` — Skill-Bericht (se-help)
...
### 4.92  `FLOW-skill-report-se-retro` — Skill-Bericht (se-retro)
...
### 4.93  `FLOW-skill-report-se-review` — Skill-Bericht (se-review)
...
### 4.94  `FLOW-skill-report-se-status` — Skill-Bericht (se-status)
...
### 4.95  `FLOW-skill-report-test` — Skill-Bericht (test)
...
### 4.96  `FLOW-skill-report-test-ui` — Skill-Bericht (test-ui)
...
### 4.97  `FLOW-skill-request` — Skill-Aufruf
...
### 4.98  `FLOW-sse-frame` — SSE-Frame (versioniert)
...
### 4.99  `FLOW-steering-delta` — Steering-Delta (vor/nach Kandidat)
...
### 4.100  `FLOW-steering-snapshot` — Steering-Snapshot
...
### 4.101  `FLOW-steering-trigger-agent` — Runden-Ausloeser (Agent)
...
### 4.102  `FLOW-store-ownership` — Store-Besitzanspruch
...
### 4.103  `FLOW-target-profile` — Zielprofil
...
### 4.104  `FLOW-target-profile-file` — Zielprofil (Rohform)
...
### 4.105  `FLOW-test-selection` — Selektive Testauswahl
...
### 4.106  `FLOW-tool-context` — Werkzeug-Kontext
...
### 5.12  `SCHEMA-gate-outcome` — MutateOutcome
...
### 5.13  `SCHEMA-generation-step` — GenerationStep
...
### 5.14  `SCHEMA-graph-delta` — GraphDelta
...
### 5.15  `SCHEMA-harness-handle` — Harness-Griff
...
### 5.20  `SCHEMA-learning-query` — Lern-Frage
...
### 5.24  `SCHEMA-mcp-tool-registry` — Werkzeug-Register
...
### 5.25  `SCHEMA-measurement-vector` — Messvektor (Vertrag der vier Entscheidungen)
...
### 5.26  `SCHEMA-metric-policy` — MetricPolicy
...
### 5.27  `SCHEMA-metric-vector` — MetricVector
...
### 5.28  `SCHEMA-model-answer` — ModelAnswer
...
### 5.29  `SCHEMA-model-request` — Modell-Anfrage
...
schema ◀ `FLOW-model-request`

### 5.30  `SCHEMA-module-metrics` — ModuleMetrics
...
### 5.31  `SCHEMA-mutate-command` — MutateCommand
...
### 5.32  `SCHEMA-mutate-result` — MutateResult
...
### 5.33  `SCHEMA-ontology-graph` — OntologyGraph
...
### 5.34  `SCHEMA-ontology-json` — OntologyJson
...
### 5.35  `SCHEMA-phase-readiness` — PhaseGateReadiness

Je Gate: abgedeckte und alle Regel-IDs plus die fehlenden.

schema ◀ `FLOW-phase-readiness`

### 5.36  `SCHEMA-preflight-outcome` — Preflight-Ergebnis
...
### 5.37  `SCHEMA-query-params` — QueryParams
...
schema ◀ `FLOW-query-request-agent` · `FLOW-query-request-auto-export` · `FLOW-query-request-owner` · `FLOW-query-request-render-views` · `FLOW-query-request-view-changelog` · `FLOW-query-request-view-conops` · `FLOW-query-request-view-fmea` · `FLOW-query-request-view-icd` · `FLOW-query-request-view-intplan` · `FLOW-query-request-view-rtm` · `FLOW-run-request` · `FLOW-skill-request` · `FLOW-steering-trigger-agent` · `FLOW-version-bump`

### 5.38  `SCHEMA-readiness-report` — ReadinessReportType
...
### 5.39  `SCHEMA-rejected-trace` — RejectedTrace
...
### 5.40  `SCHEMA-round-injection` — Runden-Injektions-Block
...
### 5.41  `SCHEMA-rule-violation` — RuleViolation
...
### 5.42  `SCHEMA-schema-fingerprint` — SchemaFingerprint
...
### 5.43  `SCHEMA-session-registry` — SessionEntry
...
### 5.46  `SCHEMA-target-profile` — TargetProfile
...
Verification ◀ `TEST-dashboard-readonly` (integration) · `TEST-help-content-coverage` (unit) · `TEST-help-projection` (unit) · `TEST-help-tool` (integration) · `TEST-mcp-readiness` (integration) · satisfy ◀ `MOD-dashboard` · allocate ▶ —
...
142 REQ · 142 verified · 0 without a verifying TEST (R-01).
