...
| `FUNC-apply-reseed` | io | `FLOW-recalled-state` |
...
| `FUNC-auto-export` | io | `FLOW-export-request` |
...
| `FUNC-block-antrieb` | allocate | `MOD-repo-root` |
...
| `FUNC-block-betrieb` | allocate | `MOD-repo-root` |
...
| `FUNC-block-live-dashboard` | allocate | `MOD-host-bridge` |
...
| `FUNC-block-speicherwerk` | allocate | `MOD-repo-root` |
...
| `FUNC-broadcast-diff` | io | `FLOW-viewer-stream` |
...
| `FUNC-create-harness` | satisfy | `REQ-single-kuzu-owner` |
...
| `FUNC-host-socket` | satisfy | `REQ-single-kuzu-owner` |
...
| `FUNC-import-code-verb` | io | `FLOW-bootstrap-result` |
...
| `FUNC-preflight` | satisfy | `REQ-small-model-viable` |
...
| `FUNC-serve-sse` | io | `FLOW-viewer-stream` |
...
| `MOD-repo-root` | compose | `MOD-completeness` |
| `MOD-repo-root` | compose | `MOD-conformance` |
| `MOD-repo-root` | compose | `MOD-dashboard` |
| `MOD-repo-root` | compose | `MOD-docs` |
| `MOD-repo-root` | compose | `MOD-element-slice` |
...
| `MOD-repo-root` | compose | `MOD-schema-migration` |
