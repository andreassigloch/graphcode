...
| `MS-3-mvp-readiness` | compose | `REQ-live-event-in-contracts` |
| `MS-3-mvp-readiness` | compose | `REQ-shared-views-no-fork` |
| `MS-3-mvp-readiness` | compose | `UC-live-graph-view` |
