...
| `FUNC-block-arch-optimierung` | allocate | `MOD-loop` |
| `FUNC-block-arch-optimierung` | compose | `FUNC-graph-suggest` |
| `FUNC-block-arch-optimierung` | compose | `FUNC-se-optimize` |
...
| `FUNC-block-bedienung` | compose | `FUNC-gve-sessions` |
| `FUNC-block-bedienung` | compose | `FUNC-gve-supervise` |
| `FUNC-block-bedienung` | compose | `FUNC-harness-cli` |
| `FUNC-block-bedienung` | compose | `FUNC-health-endpoint` |
| `FUNC-block-bedienung` | compose | `FUNC-host-socket` |
| `FUNC-block-bedienung` | compose | `FUNC-import-code-verb` |
| `FUNC-block-bedienung` | compose | `FUNC-run-verb` |
| `FUNC-block-bedienung` | compose | `FUNC-serve-stdio` |
| `FUNC-block-bedienung` | compose | `FUNC-session-shutdown` |
...
| `FUNC-block-grounding` | compose | `FUNC-block-schaufenster` |
...
| `FUNC-block-optimierung` | compose | `FUNC-block-arch-optimierung` |
...
| `FUNC-block-schaufenster` | allocate | `MOD-surface` |
