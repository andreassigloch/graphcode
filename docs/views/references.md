...
| source | type | target |
|---|---|---|
| `ACTOR-claude-code` | io | `FLOW-formatE-artifact` |
...
| `FLOW-formatE-artifact` | io | `FUNC-import` |
| `FLOW-formatE-artifact` | relation | `SCHEMA-format-e` |
| `FLOW-gate-verdict` | io | `ACTOR-developer` |
| `FLOW-gate-verdict` | io | `ACTOR-systems-engineer` |
| `FLOW-gate-verdict` | io | `FUNC-compute-phase-readiness` |
| `FLOW-gate-verdict` | io | `FUNC-graph-suggest` |
| `FLOW-gate-verdict` | io | `FUNC-health-endpoint` |
| `FLOW-gate-verdict` | io | `FUNC-save-graph` |
...
| `FLOW-graph-state` | io | `ACTOR-developer` |
...
| `FLOW-graph-state` | io | `FUNC-load-graph` |
...
| `FLOW-graph-state` | io | `FUNC-open-store` |
...
| `FLOW-query-request` | io | `FUNC-view-conops` |
| `FLOW-query-request` | io | `FUNC-view-fmea` |
| `FLOW-query-request` | io | `FUNC-view-icd` |
...
| `FLOW-test-selection` | io | `ACTOR-developer` |
| `FLOW-test-selection` | io | `ACTOR-systems-engineer` |
...
| `FUNC-apply-reseed` | io | `FLOW-graph-state` |
...
| `FUNC-block-anschluss` | allocate | `MOD-surface` |
...
| `FUNC-block-betrieb` | compose | `FUNC-cli-dispatch` |
| `FUNC-block-betrieb` | compose | `FUNC-collect-status` |
| `FUNC-block-betrieb` | compose | `FUNC-gve-sessions` |
| `FUNC-block-betrieb` | compose | `FUNC-gve-supervise` |
| `FUNC-block-betrieb` | compose | `FUNC-host-socket` |
| `FUNC-block-betrieb` | compose | `FUNC-import-code-verb` |
| `FUNC-block-betrieb` | compose | `FUNC-run-verb` |
| `FUNC-block-betrieb` | compose | `FUNC-session-shutdown` |
| `FUNC-block-betrieb` | compose | `FUNC-upgrade` |
...
| `FUNC-block-ruestzeug` | compose | `FUNC-target-profile-load` |
...
| `FUNC-block-se-steuerung` | allocate | `MOD-loop` |
...
| `FUNC-check-code-conformance` | io | `FLOW-gate-verdict` |
...
| `FUNC-close-store` | allocate | `MOD-kernel` |
| `FUNC-close-store` | io | `FLOW-graph-state` |
| `FUNC-close-store` | satisfy | `REQ-store-owner-lifecycle` |
...
| `FUNC-evaluate-rules` | io | `FLOW-gate-verdict` |
...
| `FUNC-graph-expand` | io | `FLOW-impact-subgraph` |
...
| `FUNC-import` | io | `FLOW-gate-verdict` |
...
| `FUNC-load-graph` | allocate | `MOD-kernel` |
| `FUNC-load-graph` | io | `FLOW-graph-state` |
| `FUNC-load-graph` | satisfy | `REQ-auto-persist-merge` |
| `FUNC-merge-nodes` | allocate | `MOD-kernel` |
| `FUNC-merge-nodes` | io | `FLOW-graph-state` |
...
| `FUNC-save-graph` | allocate | `MOD-kernel` |
| `FUNC-save-graph` | io | `FLOW-graph-state` |
| `FUNC-save-graph` | satisfy | `REQ-auto-persist-merge` |
