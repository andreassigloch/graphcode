...
| `CR-GC-100` | relation | `FUNC-graph-store` |
| `CR-GC-100` | relation | `FUNC-import` |
| `CR-GC-100` | relation | `FUNC-mutate` |
| `CR-GC-100` | relation | `MOD-kernel` |
...
| `CR-GC-101` | relation | `MOD-surface` |
...
| `CR-GC-102` | relation | `MOD-surface` |
...
| `CR-GC-112` | relation | `MOD-surface` |
...
| `CR-GC-113` | relation | `MOD-projections` |
...
| `CR-GC-114` | relation | `MOD-surface` |
...
| `CR-GC-116` | relation | `MOD-agent-surface` |
...
| `CR-GC-124` | relation | `MOD-surface` |
...
| `CR-GC-126` | relation | `MOD-kernel` |
| `CR-GC-126` | relation | `MOD-surface` |
...
| `CR-GC-200` | relation | `MOD-kernel` |
| `CR-GC-200` | relation | `MOD-projections` |
...
| `CR-GC-202` | relation | `MOD-surface` |
| `CR-GC-202` | relation | `MS-3-mvp-readiness` |
| `CR-GC-202` | relation | `REQ-export-no-clobber` |
| `CR-GC-203` | relation | `MOD-agent-surface` |
| `CR-GC-203` | relation | `MOD-kernel` |
| `CR-GC-203` | relation | `MOD-surface` |
| `CR-GC-203` | relation | `MS-4-mvp2` |
| `CR-GC-204` | relation | `MOD-surface` |
...
| `CR-GC-230` | relation | `MOD-projections` |
| `CR-GC-230` | relation | `MS-6-adoption` |
| `CR-GC-231` | relation | `MOD-surface` |
...
| `CR-GC-264` | relation | `MOD-projections` |
| `CR-GC-264` | relation | `MS-8-hardening` |
| `CR-GC-265` | relation | `MOD-surface` |
...
| `CR-GC-271` | relation | `MOD-projections` |
...
| `CR-GC-283` | relation | `MOD-surface` |
...
| `CR-GC-294` | relation | `MOD-agent-surface` |
...
| `CR-GC-299` | relation | `MOD-projections` |
...
| `CR-GC-301` | relation | `MOD-projections` |
...
| `CR-GC-313` | relation | `MOD-projections` |
...
| `CR-GC-316` | relation | `MOD-surface` |
...
| `CR-GC-319` | relation | `MOD-surface` |
...
| `CR-GC-322` | relation | `MOD-projections` |
...
| `CR-GC-654` | relation | `FUNC-run-executor` |
| `CR-GC-655` | relation | `FUNC-build-round-injection` |
| `CR-GC-655` | relation | `FUNC-generation-step` |
| `CR-GC-656` | relation | `FUNC-call-model` |
| `CR-GC-656` | relation | `FUNC-read-openai-stream` |
| `CR-GC-657` | relation | `FUNC-generation-step` |
| `CR-GC-657` | relation | `FUNC-run-executor` |
...
| `FCHAIN-apply-gate` | compose | `FUNC-graph-store` |
| `FCHAIN-apply-gate` | compose | `FUNC-host-socket` |
...
| `FCHAIN-model-import` | compose | `FUNC-mutate` |
...
| `FLOW-channel-fit-advisory` | relation | `SCHEMA-steering-channel` |
| `FLOW-channel-gate-protocol` | io | `FUNC-generation-step` |
| `FLOW-channel-gate-protocol` | relation | `SCHEMA-steering-channel` |
| `FLOW-channel-gate-verdict` | io | `ACTOR-agent` |
| `FLOW-channel-gate-verdict` | relation | `SCHEMA-steering-channel` |
| `FLOW-channel-grammar` | io | `FUNC-build-round-injection` |
| `FLOW-channel-grammar` | relation | `SCHEMA-steering-channel` |
| `FLOW-channel-guardrails` | io | `ACTOR-agent` |
| `FLOW-channel-guardrails` | relation | `SCHEMA-steering-channel` |
| `FLOW-channel-guidance` | io | `FUNC-build-round-injection` |
| `FLOW-channel-guidance` | relation | `SCHEMA-steering-channel` |
| `FLOW-channel-handoff` | io | `ACTOR-agent` |
| `FLOW-channel-handoff` | relation | `SCHEMA-steering-channel` |
...
| `FLOW-channel-next-step` | io | `ACTOR-agent` |
| `FLOW-channel-next-step` | relation | `SCHEMA-steering-channel` |
...
| `FLOW-channel-skill-reference` | io | `ACTOR-agent` |
| `FLOW-channel-skill-reference` | relation | `SCHEMA-steering-channel` |
| `FLOW-channel-steer-advisory` | io | `ACTOR-agent` |
| `FLOW-channel-steer-advisory` | relation | `SCHEMA-steering-channel` |
...
| `FLOW-dimension-readiness` | io | `FUNC-take-steering-snapshot` |
...
| `FLOW-install-result-collect-status` | io | `ACTOR-owner` |
| `FLOW-install-result-collect-status` | relation | `SCHEMA-cli-command` |
| `FLOW-install-result-harness-cli` | io | `ACTOR-owner` |
| `FLOW-install-result-harness-cli` | relation | `SCHEMA-cli-command` |
...
| `FLOW-mutate-cmd-agent` | io | `FUNC-host-socket` |
| `FLOW-mutate-cmd-agent` | io | `FUNC-mutate` |
| `FLOW-mutate-cmd-agent` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-author-req` | io | `FUNC-mutate` |
| `FLOW-mutate-cmd-author-req` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-author-uc` | io | `FUNC-mutate` |
| `FLOW-mutate-cmd-author-uc` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-bootstrap` | io | `FUNC-mutate` |
...
| `FLOW-mutate-cmd-import-doc` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-merge-nodes` | io | `FUNC-mutate` |
| `FLOW-mutate-cmd-merge-nodes` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-owner` | io | `FUNC-host-socket` |
| `FLOW-mutate-cmd-owner` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-se-conops` | io | `FUNC-mutate` |
| `FLOW-mutate-cmd-se-conops` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-se-fmea` | io | `FUNC-mutate` |
| `FLOW-mutate-cmd-se-fmea` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-se-generate` | io | `FUNC-mutate` |
| `FLOW-mutate-cmd-se-generate` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-se-irr` | io | `FUNC-mutate` |
| `FLOW-mutate-cmd-se-irr` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-se-optimize` | io | `FUNC-mutate` |
| `FLOW-mutate-cmd-se-optimize` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-se-plan` | io | `FUNC-mutate` |
| `FLOW-mutate-cmd-se-plan` | relation | `SCHEMA-mutate-command` |
| `FLOW-mutate-cmd-se-top-level` | io | `FUNC-mutate` |
...
| `FLOW-query-request-agent` | relation | `SCHEMA-query-params` |
| `FLOW-query-request-auto-export` | io | `FUNC-export-markdown` |
| `FLOW-query-request-auto-export` | relation | `SCHEMA-query-params` |
| `FLOW-query-request-owner` | io | `FUNC-export-markdown` |
| `FLOW-query-request-owner` | io | `FUNC-graph-expand` |
| `FLOW-query-request-owner` | io | `FUNC-list-elements` |
| `FLOW-query-request-owner` | io | `FUNC-render-views` |
| `FLOW-query-request-owner` | io | `FUNC-view-changelog` |
| `FLOW-query-request-owner` | io | `FUNC-view-conops` |
| `FLOW-query-request-owner` | io | `FUNC-view-fmea` |
| `FLOW-query-request-owner` | io | `FUNC-view-icd` |
| `FLOW-query-request-owner` | io | `FUNC-view-intplan` |
| `FLOW-query-request-owner` | io | `FUNC-view-rtm` |
| `FLOW-query-request-owner` | relation | `SCHEMA-query-params` |
| `FLOW-query-request-render-views` | io | `FUNC-export-markdown` |
| `FLOW-query-request-render-views` | relation | `SCHEMA-query-params` |
| `FLOW-query-request-view-changelog` | io | `FUNC-export-markdown` |
| `FLOW-query-request-view-changelog` | relation | `SCHEMA-query-params` |
| `FLOW-query-request-view-conops` | io | `FUNC-export-markdown` |
| `FLOW-query-request-view-conops` | relation | `SCHEMA-query-params` |
| `FLOW-query-request-view-fmea` | io | `FUNC-list-elements` |
| `FLOW-query-request-view-fmea` | io | `FUNC-read-tools` |
| `FLOW-query-request-view-fmea` | relation | `SCHEMA-query-params` |
| `FLOW-query-request-view-icd` | io | `FUNC-export-markdown` |
| `FLOW-query-request-view-icd` | relation | `SCHEMA-query-params` |
| `FLOW-query-request-view-intplan` | io | `FUNC-export-markdown` |
...
| `FLOW-skill-report-se-help` | io | `ACTOR-owner` |
| `FLOW-skill-report-se-help` | relation | `SCHEMA-markdown-view` |
| `FLOW-skill-report-se-retro` | io | `ACTOR-owner` |
| `FLOW-skill-report-se-retro` | relation | `SCHEMA-markdown-view` |
| `FLOW-skill-report-se-review` | io | `ACTOR-owner` |
| `FLOW-skill-report-se-review` | relation | `SCHEMA-markdown-view` |
| `FLOW-skill-report-se-status` | io | `ACTOR-owner` |
| `FLOW-skill-report-se-status` | relation | `SCHEMA-markdown-view` |
| `FLOW-skill-report-test` | io | `ACTOR-owner` |
| `FLOW-skill-report-test` | relation | `SCHEMA-markdown-view` |
| `FLOW-skill-report-test-ui` | io | `ACTOR-owner` |
| `FLOW-skill-report-test-ui` | relation | `SCHEMA-markdown-view` |
| `FLOW-skill-request` | io | `FUNC-author-req` |
| `FLOW-skill-request` | io | `FUNC-author-uc` |
| `FLOW-skill-request` | io | `FUNC-close-violations` |
| `FLOW-skill-request` | io | `FUNC-import-code` |
| `FLOW-skill-request` | io | `FUNC-import-doc` |
| `FLOW-skill-request` | io | `FUNC-se-conops` |
| `FLOW-skill-request` | io | `FUNC-se-fmea` |
| `FLOW-skill-request` | io | `FUNC-se-generate` |
| `FLOW-skill-request` | io | `FUNC-se-help` |
| `FLOW-skill-request` | io | `FUNC-se-irr` |
| `FLOW-skill-request` | io | `FUNC-se-optimize` |
| `FLOW-skill-request` | io | `FUNC-se-plan` |
...
| `FLOW-sse-frame` | io | `ACTOR-dashboard` |
| `FLOW-sse-frame` | relation | `SCHEMA-update-event` |
| `FLOW-steering-delta` | io | `FUNC-bind-tools` |
...
| `FLOW-store-ownership` | io | `FUNC-graph-store` |
...
| `FLOW-systemtest-artifacts` | io | `FUNC-systemtest-metrics` |
| `FLOW-systemtest-artifacts` | io | `FUNC-systemtest-turn-analyse` |
| `FLOW-systemtest-artifacts` | relation | `SCHEMA-systemtest-artifacts` |
| `FLOW-systemtest-order` | io | `FUNC-systemtest-run` |
| `FLOW-systemtest-order` | relation | `SCHEMA-systemtest-order` |
| `FLOW-systemtest-row` | io | `FUNC-systemtest-report` |
| `FLOW-systemtest-row` | relation | `SCHEMA-systemtest-row` |
| `FLOW-systemtest-turn-profile` | io | `FUNC-systemtest-report` |
| `FLOW-systemtest-turn-profile` | relation | `SCHEMA-systemtest-turn-profile` |
| `FLOW-systemtest-verdict` | io | `ACTOR-owner` |
| `FLOW-systemtest-verdict` | relation | `SCHEMA-systemtest-verdict` |
...
| `FUNC-author-req` | io | `FLOW-mutate-cmd-author-req` |
...
| `FUNC-block-anleitung` | compose | `FUNC-se-review` |
| `FUNC-block-anleitung` | compose | `FUNC-se-status` |
| `FUNC-block-anleitung` | compose | `FUNC-test` |
...
| `FUNC-block-bedienung` | compose | `FUNC-collect-status` |
| `FUNC-block-bedienung` | compose | `FUNC-harness-cli` |
| `FUNC-block-bedienung` | compose | `FUNC-import-code-verb` |
| `FUNC-block-bedienung` | compose | `FUNC-run-verb` |
| `FUNC-block-bedienung` | compose | `FUNC-upgrade` |
| `FUNC-block-betrieb` | allocate | `MOD-surface` |
| `FUNC-block-betrieb` | compose | `FUNC-block-bedienung` |
| `FUNC-block-betrieb` | compose | `FUNC-block-host-sitzung` |
| `FUNC-block-betrieb` | compose | `FUNC-block-ruestzeug` |
| `FUNC-block-dokumentenwerk` | allocate | `MOD-projections` |
...
| `FUNC-block-gate` | allocate | `MOD-kernel` |
...
| `FUNC-block-grounding` | compose | `FUNC-block-abfrage` |
| `FUNC-block-grounding` | compose | `FUNC-block-dokumentenwerk` |
| `FUNC-block-grounding` | compose | `FUNC-block-gate` |
| `FUNC-block-grounding` | compose | `FUNC-block-gedaechtnis` |
| `FUNC-block-grounding` | compose | `FUNC-block-live-dashboard` |
| `FUNC-block-grounding` | compose | `FUNC-block-messwerk` |
| `FUNC-block-grounding` | compose | `FUNC-block-speicherwerk` |
| `FUNC-block-host-sitzung` | allocate | `MOD-surface` |
| `FUNC-block-host-sitzung` | compose | `FUNC-gve-sessions` |
| `FUNC-block-host-sitzung` | compose | `FUNC-gve-supervise` |
| `FUNC-block-host-sitzung` | compose | `FUNC-health-endpoint` |
| `FUNC-block-host-sitzung` | compose | `FUNC-host-socket` |
| `FUNC-block-host-sitzung` | compose | `FUNC-serve-stdio` |
| `FUNC-block-host-sitzung` | compose | `FUNC-session-shutdown` |
| `FUNC-block-live-dashboard` | allocate | `MOD-surface` |
...
| `FUNC-block-optimierung` | compose | `FUNC-block-urteilsarbeit` |
| `FUNC-block-optimierung` | compose | `FUNC-graph-suggest` |
| `FUNC-block-optimierung` | compose | `FUNC-se-optimize` |
...
| `FUNC-block-ruestzeug` | compose | `FUNC-load-config` |
...
| `FUNC-block-speicherwerk` | compose | `FUNC-bootstrap` |
| `FUNC-block-speicherwerk` | compose | `FUNC-claim-store-lock` |
...
| `FUNC-block-urteilsarbeit` | compose | `FUNC-se-fmea` |
| `FUNC-block-urteilsarbeit` | compose | `FUNC-se-irr` |
| `FUNC-block-urteilsarbeit` | compose | `FUNC-se-plan` |
| `FUNC-block-urteilsarbeit` | compose | `FUNC-se-trade` |
| `FUNC-bootstrap` | allocate | `MOD-surface` |
| `FUNC-bootstrap` | io | `FLOW-mutate-cmd-bootstrap` |
| `FUNC-bootstrap` | satisfy | `REQ-bootstrap-through-gate` |
| `FUNC-broadcast-diff` | allocate | `MOD-surface` |
| `FUNC-broadcast-diff` | io | `FLOW-sse-frame` |
...
| `FUNC-claim-store-lock` | allocate | `MOD-kernel` |
| `FUNC-claim-store-lock` | io | `FLOW-store-ownership` |
| `FUNC-claim-store-lock` | satisfy | `REQ-store-owner-lifecycle` |
| `FUNC-cli-dispatch` | allocate | `MOD-surface` |
| `FUNC-cli-dispatch` | io | `FLOW-cli-command` |
| `FUNC-cli-dispatch` | satisfy | `REQ-npx-distribution` |
| `FUNC-close-violations` | allocate | `MOD-agent-surface` |
| `FUNC-close-violations` | io | `FLOW-mutate-cmd-close-violations` |
...
| `FUNC-emit-update-event` | allocate | `MOD-surface` |
...
| `FUNC-fit-advisory` | io | `FLOW-channel-fit-advisory` |
| `FUNC-fit-advisory` | io | `FLOW-channel-steer-advisory` |
...
| `FUNC-goal-steerer` | compose | `FUNC-block-antrieb` |
| `FUNC-goal-steerer` | compose | `FUNC-block-autorieren` |
...
| `FUNC-gve-sessions` | allocate | `MOD-surface` |
...
| `FUNC-harness-cli` | io | `FLOW-channel-guardrails` |
| `FUNC-harness-cli` | io | `FLOW-install-result-harness-cli` |
...
| `FUNC-module-metrics` | allocate | `MOD-projections` |
...
| `FUNC-render-views` | io | `FLOW-query-request-render-views` |
...
| `FUNC-score-completeness` | allocate | `MOD-projections` |
...
| `FUNC-se-conops` | allocate | `MOD-agent-surface` |
| `FUNC-se-conops` | io | `FLOW-mutate-cmd-se-conops` |
...
| `FUNC-se-help` | allocate | `MOD-agent-surface` |
| `FUNC-se-help` | io | `FLOW-skill-report-se-help` |
| `FUNC-se-help` | satisfy | `REQ-skill-reads-only` |
| `FUNC-se-irr` | allocate | `MOD-agent-surface` |
| `FUNC-se-irr` | io | `FLOW-mutate-cmd-se-irr` |
| `FUNC-se-irr` | satisfy | `REQ-skill-authors-through-gate` |
| `FUNC-se-optimize` | allocate | `MOD-agent-surface` |
| `FUNC-se-optimize` | io | `FLOW-mutate-cmd-se-optimize` |
...
| `FUNC-systemtest-metrics` | allocate | `MOD-systemtest` |
| `FUNC-systemtest-metrics` | io | `FLOW-systemtest-row` |
| `FUNC-systemtest-metrics` | satisfy | `REQ-greenfield-systemtest-dod` |
| `FUNC-systemtest-report` | allocate | `MOD-systemtest` |
| `FUNC-systemtest-report` | io | `FLOW-systemtest-verdict` |
| `FUNC-systemtest-report` | satisfy | `REQ-greenfield-systemtest-dod` |
| `FUNC-systemtest-run` | allocate | `MOD-systemtest` |
| `FUNC-systemtest-run` | io | `FLOW-systemtest-artifacts` |
| `FUNC-systemtest-run` | satisfy | `REQ-greenfield-systemtest-dod` |
| `FUNC-systemtest-turn-analyse` | allocate | `MOD-systemtest` |
| `FUNC-systemtest-turn-analyse` | io | `FLOW-systemtest-turn-profile` |
| `FUNC-systemtest-turn-analyse` | satisfy | `REQ-greenfield-systemtest-dod` |
...
| `FUNC-view-changelog` | allocate | `MOD-agent-surface` |
| `FUNC-view-changelog` | io | `FLOW-query-request-view-changelog` |
| `FUNC-view-changelog` | satisfy | `REQ-doc-export` |
| `FUNC-view-conops` | allocate | `MOD-agent-surface` |
| `FUNC-view-conops` | io | `FLOW-query-request-view-conops` |
| `FUNC-view-conops` | satisfy | `REQ-doc-export` |
| `FUNC-view-fmea` | allocate | `MOD-agent-surface` |
| `FUNC-view-fmea` | io | `FLOW-query-request-view-fmea` |
| `FUNC-view-fmea` | satisfy | `REQ-doc-export` |
| `FUNC-view-icd` | allocate | `MOD-agent-surface` |
| `FUNC-view-icd` | io | `FLOW-query-request-view-icd` |
| `FUNC-view-icd` | satisfy | `REQ-doc-export` |
| `FUNC-view-intplan` | allocate | `MOD-agent-surface` |
| `FUNC-view-intplan` | io | `FLOW-query-request-view-intplan` |
| `FUNC-view-intplan` | satisfy | `REQ-doc-export` |
| `FUNC-view-rtm` | allocate | `MOD-agent-surface` |
| `FUNC-view-rtm` | io | `FLOW-query-request-view-rtm` |
...
| `MOD-kernel` | satisfy | `REQ-harness-schema-in-contracts` |
| `MOD-kernel` | satisfy | `REQ-hook-extension-points` |
| `MOD-kernel` | satisfy | `REQ-hook-order-deterministic` |
| `MOD-kernel` | satisfy | `REQ-import-se-ontology` |
...
| `MOD-projections` | satisfy | `REQ-docs-taxonomy` |
| `MOD-projections` | satisfy | `REQ-export-no-clobber` |
| `MOD-projections` | satisfy | `REQ-formatE-parity` |
| `MOD-projections` | satisfy | `REQ-graph-integrity` |
| `MOD-projections` | satisfy | `REQ-interface-schema` |
| `MOD-projections` | satisfy | `REQ-single-measurement-path` |
| `MOD-projections` | satisfy | `REQ-testref-materialized` |
...
| `MOD-surface` | satisfy | `REQ-readonly-bridge` |
| `MOD-surface` | satisfy | `REQ-self-contained-dist` |
| `MOD-surface` | satisfy | `REQ-single-transport` |
| `MOD-surface` | satisfy | `REQ-versioned-cache` |
...
| `TEST-gve-autostart` | verify | `REQ-viewer-owned-by-repo` |
...
| `TEST-host-shim` | verify | `REQ-store-owner-lifecycle` |
...
| `TEST-systemtest-evaluations` | verify | `REQ-greenfield-systemtest-dod` |
...
| `UC-loop-closure` | compose | `FCHAIN-systemtest-run` |
