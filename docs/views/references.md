...
| `FUNC-block-live-dashboard` | compose | `FUNC-render-artifacts` |
| `FUNC-block-live-dashboard` | compose | `FUNC-render-graph` |
| `FUNC-block-live-dashboard` | compose | `FUNC-render-health` |
| `FUNC-block-live-dashboard` | compose | `FUNC-render-impact` |
| `FUNC-block-live-dashboard` | compose | `FUNC-render-impl-gates` |
| `FUNC-block-live-dashboard` | compose | `FUNC-render-readiness` |
| `FUNC-block-live-dashboard` | compose | `FUNC-render-recommendations` |
