...
| `FUNC-goal-steerer` | compose | `FUNC-generation-step` |
| `FUNC-goal-steerer` | compose | `FUNC-graph-suggest` |
| `FUNC-goal-steerer` | compose | `FUNC-next-step` |
| `FUNC-goal-steerer` | compose | `FUNC-rank-candidates` |
