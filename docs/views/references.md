...
| `ACTOR-facilitating-agent` | io | `FLOW-authoring-request` |
...
| `FLOW-violations` | io | `ACTOR-systems-engineer` |
...
| `MOD-cli` | satisfy | `REQ-install-idempotent` |
| `MOD-cli` | satisfy | `REQ-self-contained-dist` |
| `MOD-codec` | satisfy | `REQ-deterministic-serialization` |
| `MOD-codec` | satisfy | `REQ-formatE-parity` |
| `MOD-codec` | satisfy | `REQ-graph-integrity` |
| `MOD-codec` | satisfy | `REQ-interface-schema` |
| `MOD-completeness` | satisfy | `REQ-completeness-single-value` |
...
| `MOD-harness` | satisfy | `REQ-batch-seed-performance` |
| `MOD-harness` | satisfy | `REQ-disk-persistence` |
| `MOD-harness` | satisfy | `REQ-gate-only-writes` |
...
| `MOD-hooks` | satisfy | `REQ-live-event-in-contracts` |
...
| `MOD-mcp-tools` | satisfy | `REQ-cache-layering` |
...
| `MOD-steering` | satisfy | `REQ-monotone-convergence` |
| `MOD-steering` | satisfy | `REQ-phase-gate-not-skippable` |
| `MOD-steering` | satisfy | `REQ-single-measurement-path` |
