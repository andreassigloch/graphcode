...
The current vocabulary: 12 element types, 6 connection types, 30 legal connection patterns,
63 engine rules across 8 readiness dimensions, exposed as 25 MCP tools.
