...
eine Aussage über einen kleinen Nenner, kein Gütesiegel (CR-GC-548).
**Grenzmenge** = modellierte von pflichtigen Schnittstellen (Symbole, die eine MOD-Grenze kreuzen).

_Die Spalte **Reichweite** kam mit CR-GC-548 dazu; für die Zeilen davor steht `—`, weil eine
nachträglich errechnete Zahl keine gemessene ist._
...
| 2026-09-16 | 292 | CR-GC-548: Recorder repo-faehig, Greenfield-fest, meldet seine Reichweite | 768 | 3.070 / 5.000 / 0.737 / 3.947 / 4.983 / 3.922 | 3.501 | R-04@MOD-kernel | 4 | 149 | 99 % | 15/44 | 9/48 |
