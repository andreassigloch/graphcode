 ...
 */
export const MarkdownViewSchema = z.enum([
...
export function generatedHeader(title: string, subtitle: string): string {
  return [
...
export function nodesOfTypes(graph: Graph, types: string[]): GraphNode[] {
...
export function exportMarkdown(graph: Graph, view: MarkdownView): string {
  ...
  switch (v) {
    ...
    case 'srs':
      return renderSrs(graph);
    case 'nfr':
      return renderNfr(graph);
    case 'rtm':
      return renderRtm(graph);
    case 'icd':
      return renderIcd(graph);
    case 'testconcept':
      return renderTestConcept(graph);
    case 'testmatrix':
      return renderTestMatrix(graph);
    case 'intplan':
      return renderIntPlan(graph);
    case 'changelog':
      return renderChangelog(graph);
    case 'fmea':
      return renderFmea(graph);
    case 'conops':
      return renderConOps(graph);
    case 'trade':
      return renderTrade(graph);
    case 'implplan':
      return renderImplPlan(graph);
  }
}
