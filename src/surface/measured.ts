 ...
 * `moneyflow-struktur` über `new GraphCodeHarness(cfg, storage)`, und einen Korpus-Spike
 * ganz ohne Harness (gelöscht, CR-GC-676). Die beiden mittleren fielen bei fehlendem
