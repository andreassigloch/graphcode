 ...
 * `### <TYPE>`-Sektionen mehr. Die Tuer (graph-api-core, CR-SM-359) baut ihren eigenen aus demselben
 * Bestand; hier wird er fuer die Existenz- und Typpruefung der Operationen gebraucht.
 */
