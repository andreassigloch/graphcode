...
- **Benannte Abweichung:** Einen Fund, der im Modell nicht erfuellbar ist, legst du als benannte Abweichung ab: `acceptedFindings: [{ruleId, reason}]` am betroffenen Element (graphweite Regeln am SYS), der Grund ist Pflicht. Abnehmbar sind nur FM-03, AF-01, AF-02, AF-03, AF-04, AF-05, MS-01, CL-01, R-19, R-20, R-26, R-32, CR-R01 (Testlauf, Code, optionale Artefakte, Auftraggeber-Entscheidung). Architekturregeln sind nicht abnehmbar — eine Abnahme daran zaehlt nicht, der Fund bleibt: bauen. Nenne jede Abnahme in der Schlussmeldung.
