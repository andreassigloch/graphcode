...
5. **Festgefahren:** Kommt nach einem Zug derselbe Fokus wieder, stellt die Maschine ihn zurueck und nennt den naechsten (Eintrittspunkte nie — die loest nur ihr Task oder eine Abnahme). Meldet sie phase stalled, sind nur noch zurueckgestellte Funde offen: nicht weiter mutieren, sondern der Ansage folgen — im Task zurueck in den Kern, bei offenem Eintrittspunkt den Task starten, sonst die Funde und deine Versuche in der Schlussmeldung nennen. stalled ist nicht fertig.
