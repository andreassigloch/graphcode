...
// CR-GC-641 / CR-SM-359: Format-E hat eine Zod-Tuer — in graph-api-core, wo der Vertrag lebt; ihre
// eigenen Faelle stehen dort (format-e-door.test.ts). Hier nur, was graphcode zusichert: der
// Uebersetzer geht durch sie, und seine Meldung ist dieselbe wie vorher.
describe('CR-GC-641: der Uebersetzer geht durch die Tuer der Familie', () => {
  it('Parse-Fehler: dieselbe Meldung wie vorher', () => {
    expect(() => formatEToCommands({ nodes: [], edges: [] }, '## Nodes\n### REQ\numbricht ohne Praefix\n'))
